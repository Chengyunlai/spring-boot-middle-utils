package top.chengyunlai.springbootmiddleutils.service.impl;

import com.netflix.hystrix.*;
import org.aspectj.lang.ProceedingJoinPoint;
import top.chengyunlai.springbootmiddleutils.annotation.DoHystrix;
import top.chengyunlai.springbootmiddleutils.common.Result;
...
public class HystrixValveImpl extends HystrixCommand<Object> implements IValveService {
    ...
    protected Object getFallback() {
        return JSON.parseObject(JSON.toJSONString(Result.fail("服务熔断")),Result.class);
    }
